...
impl<'a> Text<'a> {
    ...
    pub fn text<B: BackendTrait>(&mut self, factory: &Backend<B>, text: &str) -> Result<(), Error> {
...
impl TextBuilder {
    ...
    pub fn layout<'a, B: BackendTrait>(self, factory: &Backend<B>, text: &str) -> Result<Text<'a>, Error> {
        let font_data = self
            .font_path
            .as_ref()
