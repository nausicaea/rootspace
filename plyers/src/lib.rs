...
pub use crate::{
    ...
    types::{
        ...
        NZ_PROPERTY, RED_PROPERTY, S_PROPERTY, TEXTURE_U_PROPERTY, TEXTURE_V_PROPERTY, T_PROPERTY, U_PROPERTY,
        VERTEX_ELEMENT, VERTEX_INDICES_LIST_PROPERTY, V_PROPERTY, X_PROPERTY, Y_PROPERTY, Z_PROPERTY,
    },
};
...
mod tests {
    ...
    use crate::types::{
        CountType, ElementDescriptor, ElementId, FormatType, ObjInfoDescriptor, PlyDescriptor, Primitive,
        PropertyDescriptor, PropertyId, Values,
    };
