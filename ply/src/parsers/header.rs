...
{
    choice([
        attempt(bytes(&b"int8"[..])),
        attempt(bytes(&b"char"[..])),
        attempt(bytes(&b"uint8"[..])),
        attempt(bytes(&b"uchar"[..])),
        attempt(bytes(&b"int16"[..])),
        attempt(bytes(&b"short"[..])),
        attempt(bytes(&b"uint16"[..])),
        attempt(bytes(&b"ushort"[..])),
        attempt(bytes(&b"int32"[..])),
        attempt(bytes(&b"int"[..])),
        attempt(bytes(&b"uint32"[..])),
        attempt(bytes(&b"uint"[..])),
        attempt(bytes(&b"float32"[..])),
        attempt(bytes(&b"float"[..])),
        attempt(bytes(&b"float64"[..])),
        attempt(bytes(&b"double"[..])),
    ]).map(|r: &[u8]| match r {
...
{
    choice([
        attempt(bytes(&b"ascii"[..])),
        attempt(bytes(&b"binary_big_endian"[..])),
        attempt(bytes(&b"binary_little_endian"[..])),
    ]).map(|r: &[u8]| match r {
