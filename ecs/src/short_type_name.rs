...
mod tests {
    ...
    fn shorten_tuple_types() {
        ...
        assert_eq!(type_name::<(usize, greek::Alpha)>(), "(usize, ecs::short_type_name::tests::greek::Alpha)");
        assert_eq!(short_type_name::<(usize, greek::Alpha)>(), "(usize, Alpha)");
    }

    #[test]
    fn shorten_array_types() {
        assert_eq!(type_name::<[greek::Alpha; 10]>(), "[ecs::short_type_name::tests::greek::Alpha; 10]");
        assert_eq!(short_type_name::<[greek::Alpha; 10]>(), "[Alpha; 10]");
    }

    #[test]
    fn shorten_reference_types() {
        assert_eq!(type_name::<&greek::Beta<&greek::Alpha>>(), "&ecs::short_type_name::tests::greek::Beta<&ecs::short_type_name::tests::greek::Alpha>");
    ...
    fn shorten_t1_generics() {
        assert_eq!(type_name::<greek::Beta<usize>>(), "ecs::short_type_name::tests::greek::Beta<usize>");
    ...
    fn shorten_t2_generics() {
        assert_eq!(type_name::<greek::Gamma<usize, usize>>(), "ecs::short_type_name::tests::greek::Gamma<usize, usize>");
        ...
        assert_eq!(short_type_name::<greek::Gamma<greek::Alpha, greek::Alpha>>(), "Gamma<Alpha, Alpha>");
    }
    ...
    fn shorten_nasty_generics() {
        ...
        assert_eq!(short_type_name::<greek::Gamma<(greek::Alpha, usize), [greek::Alpha; 10]>>(), "Gamma<(Alpha, usize), [Alpha; 10]>");
    }
}
